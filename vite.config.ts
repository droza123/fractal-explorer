  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        screenshots: [
          {
            src: 'screenshots/desktop-julia.png',
            sizes: '2880x1800',
            type: 'image/png',
            form_factor: 'wide',
          ...
          {
            src: 'screenshots/desktop-3d.png',
            sizes: '2560x1440',
            type: 'image/png',
            form_factor: 'wide',
          ...
          {
            src: 'screenshots/desktop-mandelbrot.png',
            sizes: '2880x1800',
            type: 'image/png',
            form_factor: 'wide',
          ...
          {
            src: 'screenshots/desktop-heatmap.png',
            sizes: '2560x1440',
            type: 'image/png',
            form_factor: 'wide',
          ...
          {
            src: 'screenshots/animations-with-keyframes.png',
            sizes: '898x824',
            type: 'image/png',
            form_factor: 'narrow',
          ...
          {
            src: 'screenshots/export-video.png',
            sizes: '2560x1440',
            type: 'image/png',
            form_factor: 'wide',
          ...
          {
            src: 'screenshots/saved-julia-sets.png',
            sizes: '2560x1440',
            type: 'image/png',
            form_factor: 'wide',
          ...
          {
            src: 'screenshots/export-images.png',
            sizes: '2560x1440',
            type: 'image/png',
            form_factor: 'wide',
          ...
          {
            src: 'screenshots/color-palette.png',
            sizes: '2560x1440',
            type: 'image/png',
            form_factor: 'wide',
          ...
          {
            src: 'screenshots/custom-palette.png',
            sizes: '2560x1440',
            type: 'image/png',
            form_factor: 'wide',
